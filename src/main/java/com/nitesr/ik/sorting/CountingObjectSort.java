...
public class CountingObjectSort<T> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(printObjectArray(array6)+".sort = "+printObjectArray(sortedArray6));
        ...
        System.out.println(printObjectArray(array7)+".sort = "+printObjectArray(sortedArray7));
