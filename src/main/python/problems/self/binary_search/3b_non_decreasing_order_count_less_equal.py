...
Given a list of non-decreasing order of elements in an array and target
    find number of elements that are less  or equal to target
"""
...
class Testcase(unittest.TestCase):
    TEST_CASES = [
        # Basic cases
        {"nums": [1, 2, 2, 3, 3, 4, 5], "target": 3, "expected": 5, "description": "exists in middle"}
        ,{"nums": [1, 2, 3, 4, 5], "target": 2, "expected": 2, "description": "exists in left half"}
        ,{"nums": [1, 2, 3, 3, 4, 5], "target": 4, "expected": 5, "description": "exists in right half"}
        ...
        ,{"nums": [2, 2, 2, 2, 2, 2], "target": 3, "expected": 6, "description": "all same elements, equal"}
        
       
        # Boundary cases
        ,{"nums": [1, 1, 1, 2, 3, 4, 5, 5, 5, 5], "target": 1, "expected": 3, "description": "first elment"}
        ,{"nums": [1, 1, 1, 2, 3, 4, 5, 5, 5, 5], "target": 5, "expected": 10, "description": "last elment"}
