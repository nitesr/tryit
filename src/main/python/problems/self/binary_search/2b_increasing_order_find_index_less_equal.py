...
class Testcase(unittest.TestCase):
    TEST_CASES = [
        # Basic cases
        {"nums": [1, 2, 3, 4, 5], "target": 3, "expected": 3, "description": "exists in middle"}
        ,{"nums": [1, 2, 3, 4, 5], "target": 2, "expected": 2, "description": "exists in left half"}
        ,{"nums": [1, 2, 3, 4, 5], "target": 4, "expected": 4, "description": "exists in right half"}
        ...
        # Boundary cases
        ,{"nums": [1, 2, 3, 4, 5], "target": 1, "expected": 1, "description": "first elment"}
        ,{"nums": [1, 2, 3, 4, 5], "target": 5, "expected": 5, "description": "last elment"}
