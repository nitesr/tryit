...
def postorder_traversal(node: Node) -> List[int]:
    if not node:
        return []
...
class Testcase(unittest.TestCase):
    TEST_CASES = [
        # Basic cases
        {"tree": [1, 2, 6, 3, 5, 7, 8, None, 4, None, None, None, None, 9], "expected": [4, 3, 5, 2, 7, 9, 8, 6, 1], "description": "a tree"}
        ...
        ,{"tree": [1, None, 2, None, 3, None, 4], "expected": [4, 3, 2, 1], "description": "right only tree"}

        # Boundary cases
        ,{"tree": [1, 2, 6, 3, 4, 5, 8], "expected": [3, 4, 2, 5, 8, 6, 1], "description": "a complete tree"}
    ]
